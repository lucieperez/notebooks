...
pri_manual <- c(
  # cmpl_animanim
  set_prior("student_t(5, 0, 1.5)", class="b", coef="cmpl_animanim", dpar="mudirhe"),
  set_prior("student_t(5, 0, 1.5)", class="b", coef="cmpl_animanim", dpar="muprepdirhe"),
  set_prior("student_t(5, 0, 1.5)", class="b", coef="cmpl_animanim", dpar="muvc"),
  
  # cmpl_complexcomplex
  set_prior("student_t(5, 0, 1.5)", class="b", coef="cmpl_complexcomplex", dpar="mudirhe"),
  set_prior("student_t(5, 0, 1.5)", class="b", coef="cmpl_complexcomplex", dpar="muprepdirhe"),
  set_prior("student_t(5, 0, 2.5)", class="b", coef="cmpl_complexcomplex", dpar="muvc"),
  
  # cmpl_detund
  set_prior("student_t(5, 0, 1.5)", class="b", coef="cmpl_detund", dpar="mudirhe"),
  set_prior("student_t(5, 0, 1.5)", class="b", coef="cmpl_detund", dpar="muprepdirhe"),
  set_prior("student_t(5, 0, 1.5)", class="b", coef="cmpl_detund", dpar="muvc"),
  
  # motion_typefictive
  set_prior("student_t(5, 0, 1.5)", class="b", coef="motion_typefictive", dpar="mudirhe"),
  set_prior("student_t(5, 0, 1.5)", class="b", coef="motion_typefictive", dpar="muprepdirhe"),
  set_prior("student_t(5, 0, 1.5)", class="b", coef="motion_typefictive", dpar="muvc"),
  
  # intercepts for each category-specific predictor
  set_prior("student_t(5, 0, 2.5)", class="Intercept", dpar="mudirhe"),
  set_prior("student_t(5, 0, 2.5)", class="Intercept", dpar="muprepdirhe"),
  set_prior("student_t(5, 0, 2.5)", class="Intercept", dpar="muvc")
)
...
### Model 3 - BOok_scroll / lex as crossed factors (student-t priors)
...
saveRDS(motion_verb_3, file = "models/motion_verb_3.rds")


### Model 4 - Book_scroll / lex as nested factors (student-t priors)
...
# save the fitted model to a file
saveRDS(motion_verb_4_nested, file = "models/motion_verb_4_nested.rds")
